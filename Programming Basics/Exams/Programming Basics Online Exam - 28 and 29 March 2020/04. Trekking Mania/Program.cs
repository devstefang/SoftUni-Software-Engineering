...
namespace _04._Trekking_Mania
    {
        class Program
        {
            static void Main(string[] args)
            {
                ...
                Console.WriteLine($"{Math.Ceiling(musalaTotal):f2}");
                Console.WriteLine($"{Math.Ceiling(monblanTotal):f2}");
                Console.WriteLine($"{Math.Ceiling(kilimandjaroTotal):f2}");
                Console.WriteLine({$"{Math.Ceiling(k2Total):f2}");
                Console.WriteLine($"{Math.Ceiling(everestTotal):f2}");
            }
        }
    }
